...
description: "SRS (average and ratio) with UPSWR (Hansen–Hurwitz)"
format:
  html:
    theme: flatly
    page-layout: full
...
::: {.appsource}
This app accompanies [Shinylive App Comparing SRS and UPSWR](ups.html#sec-ups-app){target="_blank"}
