...
```{r make-acres92, include=FALSE}
# a standalone copy of the cleaned column
write.csv(agpop["acres92"], "acres92.csv", row.names = FALSE, quote = FALSE)

# the block to paste at the end of the shinylive chunk
writeLines(
  c("## file: acres92.csv",
    "acres92",
    format(agpop$acres92, trim = TRUE, scientific = FALSE)),
  "acres92-block.txt"
)
```
