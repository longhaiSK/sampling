...
* **Standard Error:** $SE(\bar{y}) = \sqrt{1 - \frac{n}{N}} \left( \frac{s}{\sqrt{n}} \right)$
* **Margin of Error:** $ME = t_{\alpha/2, n-1} \times SE(\bar{y})$
...
Define the target sample size and compute the true population mean ($\mu$) and theoretical standard error ($SE_{true}$) using the known population standard deviation ($S$).

**Theoretical Standard Error:**


$$SE_{true}(\bar{y}) = \sqrt{1 - \frac{n}{N}} \left(\frac{S}{\sqrt{n}}\right)$$
