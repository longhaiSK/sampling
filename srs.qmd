...
Interactive Shinylive app for simple random sampling: draw samples of a chosen
size from the `acres92` population, watch the sampled units highlight on the
population panel, and accumulate the resulting sample means against the
theoretical sampling distribution and confidence-interval coverage.
:::
