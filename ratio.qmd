...
ratio_mean_volume_raw <- ratio_est(ydata, xdata, xbarU = mean_diameters, N = N, estimate = "mean")$estimate
...
```{r}
t_diameters <- 41835
ratio_est(ydata, xdata, xbarU = t_diameters / N, N = N, estimate = "total")$estimate |>
  format_est_gt("total")
```
