...
The right panel accumulates the estimates of both designs, one column each, with
a violin summarising each cloud once enough draws have accumulated. The bar
beside each column is the current confidence interval, green when it covers
